...
const PortfolioPage: React.FC<PortfolioPageProps> = ({
  ...
  return (
    /* When aurora is active we keep the wrapper transparent so the fixed canvas shows through */
    <div className={`text-foreground geist-font ${showAnimatedBackground ? 'bg-transparent' : 'bg-background'}`}>
